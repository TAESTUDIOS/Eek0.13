...
;
  ...
  // Note: Reminders are now triggered automatically by the scheduler at the appropriate times.
  // No need to trigger them immediately on save.
  ...
  const handleSaveAppointment = async () => {
    ...
    try {
      ...
      // Reminders will be triggered automatically by the scheduler at the appropriate times
